...
const val previewColumns = "feed_item.id AS id, guid, plain_title, plain_snippet, feed_item.image_url, enclosure_link, " +
        "author, pub_date, link, unread, feed.tag AS tag, feed.id AS feed_id, feed.title AS feed_title, feed.url AS feed_url"
